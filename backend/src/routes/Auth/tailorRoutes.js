import { tailorSignup, tailorLogin, tailorLogout, getAllTailors, getTailorById, updateTailorProfile, getTailorReviews } from "../../controllers/Auth/tailorController.js";
...
router.post("/logout", authMiddleware, isTailor, tailorLogout);
router.get("/:id", getTailorById);
router.get("/:id/reviews", getTailorReviews);
